...
public class MassageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        massegeEdt = findViewById(R.id.massegeEdt);
        ...
        Window window = MassageActivity.this.getWindow();
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.setStatusBarColor(ContextCompat.getColor(MassageActivity.this,R.color.massage));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MassageActivity.this, "QR Code Saved", Toast.LENGTH_SHORT).show();
    ...
    private  void generateQR(){
        ...
        String massage= massegeEdt.getText().toString();

        String phnMassage= phone+ "\n"+massage;


        if (TextUtils.isEmpty(phone)) {

            Toast.makeText(MassageActivity.this, "Enter Phone Number to generate QR Code", Toast.LENGTH_SHORT).show();
        } else {
            ...
            qrgEncoder = new QRGEncoder(phnMassage, null, QRGContents.Type.TEXT, dimen);
            try {
    ...
    private Uri getImageToShare (Bitmap bitmap){
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            uri = FileProvider.getUriForFile(MassageActivity.this,"com.itnation.imagesearch", file);
        } catch (Exception e){
