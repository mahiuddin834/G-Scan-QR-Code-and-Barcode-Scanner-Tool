...
public class PhoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setStatusBarColor(ContextCompat.getColor(PhoneActivity.this,R.color.pink));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PhoneActivity.this, "QR Code Saved", Toast.LENGTH_SHORT).show();
    ...
    private  void generateQR(){
        ...
        if (TextUtils.isEmpty(phone)) {
            ...
            Toast.makeText(PhoneActivity.this, "Enter Phone Number to generate QR Code", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private Uri getImageToShare (Bitmap bitmap){
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            uri = FileProvider.getUriForFile(PhoneActivity.this,"com.itnation.imagesearch", file);
        } catch (Exception e){
