...
public class UrlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = UrlActivity.this.getWindow();
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.setStatusBarColor(ContextCompat.getColor(UrlActivity.this,R.color.url));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(UrlActivity.this, "QR Code Saved", Toast.LENGTH_SHORT).show();
    ...
    private  void generateQR(){
        ...
        if (TextUtils.isEmpty(phone)) {
            ...
            Toast.makeText(UrlActivity.this, "Enter Phone Number to generate QR Code", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private Uri getImageToShare (Bitmap bitmap){
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            uri = FileProvider.getUriForFile(UrlActivity.this,"com.itnation.imagesearch", file);
        } catch (Exception e){
