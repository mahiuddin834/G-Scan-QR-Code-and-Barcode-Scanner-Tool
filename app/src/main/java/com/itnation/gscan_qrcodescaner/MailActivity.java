...
public class MailActivity extends AppCompatActivity {
    ...
    ImageButton backButton, share, save;
    RelativeLayout shareSaveLaye;
    EditText emailEdt, subjectEdit, bodyEdt;
    LinearLayout qrLay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bodyEdt = findViewById(R.id.bodyEdt);
...
/*
        Window window = MailActivity.this.getWindow();
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.setStatusBarColor(ContextCompat.getColor(MailActivity.this,R.color.pink));
 ...
 */
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MailActivity.this, "QR Code Saved", Toast.LENGTH_SHORT).show();
    ...
    private  void generateQR(){
        ...
        String dataEdit = email + "\n" + subject + "\n" + body;

        if (TextUtils.isEmpty(email)) {

            Toast.makeText(MailActivity.this, "Enter Email to generate QR Code", Toast.LENGTH_SHORT).show();
        } else {
            ...
            qrgEncoder = new QRGEncoder(dataEdit, null, QRGContents.Type.TEXT, dimen);
            try {
    ...
    private Uri getImageToShare (Bitmap bitmap){
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            uri = FileProvider.getUriForFile(MailActivity.this,"com.itnation.imagesearch", file);
        } catch (Exception e){
