...
public class WifiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        netEdt = findViewById(R.id.netEdt);
        ...
        Window window = WifiActivity.this.getWindow();
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.setStatusBarColor(ContextCompat.getColor(WifiActivity.this,R.color.wifi));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(WifiActivity.this, "QR Code Saved", Toast.LENGTH_SHORT).show();
    ...
    private  void generateQR(){
        ...
        String netName= netEdt.getText().toString();
        String password= passEdt.getText().toString();

        String alldata= netName+"/n"+password;


        if (TextUtils.isEmpty(netName)) {

            Toast.makeText(WifiActivity.this, "Enter Phone Number to generate QR Code", Toast.LENGTH_SHORT).show();
        } else {
            ...
            qrgEncoder = new QRGEncoder(alldata, null, QRGContents.Type.TEXT, dimen);
            try {
    ...
    private Uri getImageToShare (Bitmap bitmap){
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            uri = FileProvider.getUriForFile(WifiActivity.this,"com.itnation.imagesearch", file);
        } catch (Exception e){
